...
CREATE UNIQUE INDEX USER_ID_INDEX ON APPUSER (USER_ID);
...
CREATE TABLE IF NOT EXISTS USER_ROLES (
	...
	CREATED_AT TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  UPDATED_AT TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
	CONSTRAINT USER_FK FOREIGN KEY (USER_ID) REFERENCES APPUSER (USER_ID) ON DELETE RESTRICT ON UPDATE RESTRICT,
